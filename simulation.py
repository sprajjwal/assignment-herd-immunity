...
class Simulation(object):
    ...
    def run(self):
        ...
        print(f"Time step 0, Total infected: {self.total_infected}, current infected: {self.current_infected}, vaccinated percentage: {self.vacc_percentage}, dead: {self.total_dead}")
        while True:
            ...
            print(f"Time step: {time_step_counter}, total infected: {self.total_infected}, current infected: {self.current_infected} vaccinated %: {self.vacc_percentage}, dead: {self.total_dead},  total vaccinated: {len(vaccinated)}, alive: {len(alive)}, uninfected: {len(uninfected)}")
