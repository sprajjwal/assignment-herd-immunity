...
class Simulation(object):
    ...
    def __init__(self, pop_size, vacc_percentage, virus, initial_infected=1):
        ...
        since the simulation began, including the currently infected people who
        died.
...
# return [person for person in self.population if person.infection
# and person.is_alive]
...
# and person._id != id]
    ...
    def _create_population(self, initial_infected):
        ...
        '''
        population = []  # return value

        # store a number for the number of vaccinated people
        number_vaccinated = round(self.vacc_percentage * self.pop_size)

        total = random.sample(range(self.pop_size),
                              number_vaccinated + self.initial_infected)
        # randomly determine which people start out infected
    ...
    def _infect_newly_infected(self):
        ''' This method should iterate through the list of ._id stored
            in self.newly_infected and update each Person object with
            the disease. '''
